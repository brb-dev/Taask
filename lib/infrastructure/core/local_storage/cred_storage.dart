...
import '../../auth/dtos/cred_dto.dart';
import 'secure_storage.dart';

class CredStorage {
  static const _boxName = 'taask_cred_box';
  static const _credKey = 'taask_auth_cred';
  static const _secureKey = 'taask_cred_secure';
  ...
  Future<CredDto> get() async {
    try {
      return await _encryptedBox.get(
        _credKey,
        defaultValue: CredDto(email: '', password: ''),
      );
    } catch (e) {
